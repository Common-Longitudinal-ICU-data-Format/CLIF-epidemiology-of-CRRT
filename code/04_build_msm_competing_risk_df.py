"""
Build the MSM / competing-risk analysis dataframe (49 columns).
...
# ===================================================================
# STEP 10: Final column ordering per schema (49 columns)
# ===================================================================
# Drop helper column used for SCUF exclusion
if "has_dialysate_24h" in result.columns:
    result.drop(columns=["has_dialysate_24h"], inplace=True)
